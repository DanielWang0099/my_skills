...
`skills/c-academic-research-suite/SKILL.md`, then reads the vendored workflow
files under `ars/`.
...
|---|---|
| `deep-research`, `academic-paper`, `academic-paper-reviewer`, `academic-pipeline` as separate skills | Vendored workflows selected by the single `$c-academic-research-suite` router |
