...
`c-academic-research-suite`. Vendored upstream content remains under `ars/`; do
...
```text
Use $c-academic-research-suite: ars-plan ...
```
...
```bash
python3 skills/c-academic-research-suite/codex/scripts/ars_codex_quality_gates.py all
python3 -m pytest skills/c-academic-research-suite/codex/tests
```
